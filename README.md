...
A well-structured collection of Shell Scripting scripts — from basics to advanced topics — with hands-on assignments.
...
| `04_variables_advanced.sh` | Command substitution, hostname, date |
